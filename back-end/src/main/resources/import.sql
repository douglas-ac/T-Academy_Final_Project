...
INSERT INTO `announcement`(`bairro`,`cep`,`complemento`, `localidade`,`logradouro`,`uf`,`amount`,`date`,`product_id`,`user_id`) VALUES ('Centro','40000-000',NULL,'Feira de Santana','Praça Castro Alves','BA',1,'2022-01-01 00:00:00',3,1);
...
INSERT INTO `announcement`(`bairro`,`cep`,`complemento`, `localidade`,`logradouro`,`uf`,`amount`,`date`,`product_id`,`user_id`) VALUES ('Centro','40000-000',NULL,'Aracaju','Praça Castro Alves','SE',1,'2022-01-01 00:00:00',8,3);
...
INSERT INTO `announcement`(`bairro`,`cep`,`complemento`, `localidade`,`logradouro`,`uf`,`amount`,`date`,`product_id`,`user_id`) VALUES ('Lapa','42222-222',NULL,'Vitória','Copacabana','ES',1,'2022-05-20 00:00:00',6,2);
INSERT INTO `announcement`(`bairro`,`cep`,`complemento`, `localidade`,`logradouro`,`uf`,`amount`,`date`,`product_id`,`user_id`) VALUES ('Lapa','42222-222',NULL,'Natal','Copacabana','RN',1,'2022-05-20 00:00:00',9,3);
INSERT INTO `announcement`(`bairro`,`cep`,`complemento`, `localidade`,`logradouro`,`uf`,`amount`,`date`,`product_id`,`user_id`) VALUES ('Lapa','42222-222',NULL,'Porto Alegre','Copacabana','RS',1,'2022-05-20 00:00:00',10,3);
...
INSERT INTO `announcement`(`bairro`,`cep`,`complemento`, `localidade`,`logradouro`,`uf`,`amount`,`date`,`product_id`,`user_id`) VALUES ('Matriz','41000-000',NULL,'Blumenau','Praça da Matriz','SC',5,'2022-07-29 00:00:00',12,2);
INSERT INTO `announcement`(`bairro`,`cep`,`complemento`, `localidade`,`logradouro`,`uf`,`amount`,`date`,`product_id`,`user_id`) VALUES ('Matriz','41000-000',NULL,'Fortaleza','Praça da Matriz','CE',1,'2022-07-29 00:00:00',13,3);
...
INSERT INTO `announcement`(`bairro`,`cep`,`complemento`, `localidade`,`logradouro`,`uf`,`amount`,`date`,`product_id`,`user_id`) VALUES ('Matriz','41000-000',NULL,'São Paulo','Praça da Matriz','SP',7,'2022-07-29 00:00:00',15,2);
INSERT INTO `announcement`(`bairro`,`cep`,`complemento`, `localidade`,`logradouro`,`uf`,`amount`,`date`,`product_id`,`user_id`) VALUES ('Matriz','41000-000',NULL,'Santo André','Praça da Matriz','SP',4,'2022-07-29 00:00:00',16,3);
